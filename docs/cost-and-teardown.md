...
whole environment at eight hours. NAT, SQL, Backup for GKE, and regional HA are
...
workloads, addons, cluster, platform, and network in that order. Final teardown
empties state, deletes the state bucket, unlinks billing, and deletes the project.
